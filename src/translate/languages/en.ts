  ...
  en: {
    ...
    skills: {
      ...
      hardSkillsTopics: {
        ...
        2: "HTML, CSS, Sass, Styled Components, Bootstrap, (responsive design) and Figma",
        3: "ReactJS (Redux, Saga, Hooks, Form, Performance, Context etc.) and major related libraries.",
        4: "React Native",
        5: "Next.js",
        6: "Unitary tests (Jest and Testing Library)",
        7: "Component documentation (Storybook)",
        8: "HTTP and API integration (Axios)",
        9: "Node.js and Database",
        10: "Advanced Git",
        11: "Intermediary English",
      },
