    ...
    pt:{
        ...
        formation:{
            ...
            academicEducationTopics: {
                1:"Ensino Fundamental na EEF Renato de Araújo Carneiro (Término em 2014)",
                2:"Ensino Médio e Curso Técnico em Informática na EEEP Maria Cavalcante Costa (2015 - 2017)",
                3:"Bacharelado (Summa Cum Laude) em Sistemas de Informação na UFC - Quixadá (2018 - 2022) ⭐",
                4:"Formação Ignite na Rocketseat - Trilhas de ReactJS (2022 - 2023)"
            },
        ...
        skills:{
            ...
            hardSkillsTopics: {
                ...
                2:"HTML, CSS, Sass, Styled Components, Bootstrap, (design responsivo) e Figma (básico)",
                3:"ReactJS (Redux, Saga, Hooks, Form, Performance, ContextAPI etc.) e principais bibliotecas relacionadas.",
                4:"Testes unitários (Jest e Testing Library)",
                5:"Documentação de componentes (Storybook)",
                6:"Noções de Next.js",
                7:"HTTP e integração com APIs",
                8:"Node.js e Banco de dados (básico)",
                9:"Git e SCRUM",
