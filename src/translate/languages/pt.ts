  ...
  pt: {
    ...
    skills: {
      ...
      hardSkillsTopics: {
        ...
        2: "HTML, CSS, Sass, Styled Components, Bootstrap, (design responsivo) e Figma",
        3: "ReactJS (Redux, Saga, Hooks, Form, Performance, Context etc.) e principais bibliotecas relacionadas.",
        4: "React Native",
        5: "Next.js",
        6: "Testes unitários (Jest e Testing Library)",
        7: "Documentação de componentes (Storybook)",
        8: "HTTP e integração com APIs (Axios)",
        9: "Node.js e Banco de dados",
        10: "Git avançado",
        11: "Inglês Intermediário",
      },
